...
namespace laser_filters
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PolygonFilterConfig &config, const PolygonFilterConfig &max, const PolygonFilterConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PolygonFilterConfig &config1, const PolygonFilterConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PolygonFilterConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PolygonFilterConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PolygonFilterConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PolygonFilterConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PolygonFilterConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PolygonFilterConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
