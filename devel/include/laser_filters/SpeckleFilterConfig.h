...
namespace laser_filters
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(SpeckleFilterConfig &config, const SpeckleFilterConfig &max, const SpeckleFilterConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const SpeckleFilterConfig &config1, const SpeckleFilterConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, SpeckleFilterConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const SpeckleFilterConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, SpeckleFilterConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const SpeckleFilterConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const SpeckleFilterConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, SpeckleFilterConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
