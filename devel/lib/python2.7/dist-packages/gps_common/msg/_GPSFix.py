...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.status.satellites_used
      buff.write(_get_struct_H().pack(_x))
      length = len(self.status.satellite_used_prn)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.status.satellite_used_prn))
      _x = self.status.satellites_visible
      buff.write(_get_struct_H().pack(_x))
      length = len(self.status.satellite_visible_prn)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.status.satellite_visible_prn))
      length = len(self.status.satellite_visible_z)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.status.satellite_visible_z))
      length = len(self.status.satellite_visible_azimuth)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.status.satellite_visible_azimuth))
      length = len(self.status.satellite_visible_snr)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.status.satellite_visible_snr))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.status.satellite_used_prn = s.unpack(str[start:end])
      start = end
      end += 2
      ...
      self.status.satellite_visible_prn = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.status.satellite_visible_z = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.status.satellite_visible_azimuth = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.status.satellite_visible_snr = s.unpack(str[start:end])
      _x = self
      start = end
      end += 208
