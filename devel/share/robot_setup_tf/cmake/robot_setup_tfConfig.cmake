...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/young43/FOSCAR_ISCC_2021/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/young43/FOSCAR_ISCC_2021/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/young43/FOSCAR_ISCC_2021/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'parkhojun <parkhojun@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/young43/FOSCAR_ISCC_2021/src/robot_setup_tf/${idir}'.  ${_report}")
    endif()
