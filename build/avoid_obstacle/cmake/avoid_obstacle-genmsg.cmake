...
set(MSG_I_FLAGS "-Iavoid_obstacle:/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/TrueObstacles.msg" NAME_WE)
add_custom_target(_avoid_obstacle_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "avoid_obstacle" "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/TrueObstacles.msg" ""
)

get_filename_component(_filename "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/PointObstacles.msg" NAME_WE)
add_custom_target(_avoid_obstacle_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "avoid_obstacle" "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/PointObstacles.msg" ""
)

get_filename_component(_filename "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/DetectedObstacles.msg" NAME_WE)
add_custom_target(_avoid_obstacle_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "avoid_obstacle" "/home/young43/FOSCAR_ISCC_2021/src/avoid_obstacle/msg/DetectedObstacles.msg" "avoid_obstacle/PointObstacles"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/avoid_obstacle)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/avoid_obstacle\")")
  # install generated code
  install(
