...
set(MSG_I_FLAGS "-Irace:/home/young/FOSCAR_ISCC_2021/src/race/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/young/FOSCAR_ISCC_2021/src/race/msg/mode.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/young/FOSCAR_ISCC_2021/src/race/msg/mode.msg" ""
)

get_filename_component(_filename "/home/young/FOSCAR_ISCC_2021/src/race/msg/lane_info.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/young/FOSCAR_ISCC_2021/src/race/msg/lane_info.msg" ""
)

get_filename_component(_filename "/home/young/FOSCAR_ISCC_2021/src/race/msg/enc_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/young/FOSCAR_ISCC_2021/src/race/msg/enc_values.msg" ""
)

get_filename_component(_filename "/home/young/FOSCAR_ISCC_2021/src/race/msg/test.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/young/FOSCAR_ISCC_2021/src/race/msg/test.msg" ""
)

get_filename_component(_filename "/home/young/FOSCAR_ISCC_2021/src/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/young/FOSCAR_ISCC_2021/src/race/msg/drive_values.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race\")")
  # install generated code
  install(
