class PidCal:
    error_sum = 0
    error_old = 0
    p = [0.0444, 0.00005, 0.03] # 0.0444 # optimized kp,ki,kd
    #p = [0.0020, 0.000005, 0.005]
    #p = [0.0022, 0.000005, 0.005]
    ...
    def cal_error(self, setpoint=500):
    ...
    def pid_control(self, x_current, setpoint=500):
