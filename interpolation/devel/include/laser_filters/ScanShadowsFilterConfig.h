...
namespace laser_filters
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ScanShadowsFilterConfig &config, const ScanShadowsFilterConfig &max, const ScanShadowsFilterConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ScanShadowsFilterConfig &config1, const ScanShadowsFilterConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ScanShadowsFilterConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ScanShadowsFilterConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ScanShadowsFilterConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ScanShadowsFilterConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ScanShadowsFilterConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ScanShadowsFilterConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
