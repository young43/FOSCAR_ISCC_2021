...
namespace laser_filters
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(SectorFilterConfig &config, const SectorFilterConfig &max, const SectorFilterConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const SectorFilterConfig &config1, const SectorFilterConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, SectorFilterConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const SectorFilterConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, SectorFilterConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const SectorFilterConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const SectorFilterConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, SectorFilterConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
