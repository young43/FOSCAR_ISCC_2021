...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.satellites_used
      buff.write(_get_struct_H().pack(_x))
      length = len(self.satellite_used_prn)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.satellite_used_prn))
      _x = self.satellites_visible
      buff.write(_get_struct_H().pack(_x))
      length = len(self.satellite_visible_prn)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.satellite_visible_prn))
      length = len(self.satellite_visible_z)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.satellite_visible_z))
      length = len(self.satellite_visible_azimuth)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.satellite_visible_azimuth))
      length = len(self.satellite_visible_snr)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.satellite_visible_snr))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.satellite_used_prn = s.unpack(str[start:end])
      start = end
      end += 2
      ...
      self.satellite_visible_prn = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.satellite_visible_z = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.satellite_visible_azimuth = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.satellite_visible_snr = s.unpack(str[start:end])
      _x = self
      start = end
      end += 8
